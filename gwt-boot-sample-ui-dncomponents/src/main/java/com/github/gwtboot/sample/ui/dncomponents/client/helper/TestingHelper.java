...
public class TestingHelper {
	public static String[] surnames_list = { "Smith", "Johnson", "Williams", "Brown", "Jones", "Miller", "Davis",
			...
			"Velasquez", "Montoya", "Roth", "Meyers", "Cardenas", "Fuentes", "Weiss", "Wilkins", "Hoover", "Nicholson",
			...
			"Clay", "Barron", "Beasley", "Oneal", "Small", "Preston", "Wu", "Zamora", "Macdonald", "Vance", "Snow",
			...
			"Mccullough", "Lester", "Santana", "Valenzuela", "Winters", "Barrera", "Orr", "Leach", "Berger", "Mckee",
			...
			"Barr", "Gaines", "Durham", "Gentry", "Mcintyre", "Sloan", "Rocha", "Melendez", "Herman", "Sexton", "Moon",
			...
			"Davila", "Rowland", "Madden", "Levine", "Spence", "Good", "Irwin", "Werner", "Krause", "Petty", "Whitney",
			...
			"Key", "Cooke" };
	public static String[] male_names_list = { "James", "John", "Robert", "Michael", "William", "David", "Richard",
	...
	public static String[] female_names_list = { "Mary", "Patricia", "Linda", "Barbara", "Elizabeth", "Jennifer",
			...
			"Felecia", "Sharlene", "Lesa", "Beverley", "Robert", "Isabella", "Herminia", "Terra", "Celina" };
	public static ArrayList<Person> people_list = new ArrayList<>();
	public static String[] colors = { "aliceblue", "antiquewhite", "aqua", "aquamarine", "azure", "beige", "bisque",
	...
	public static ArrayList<String> getMaleNames(int numberOfRecords) {
		...
		for (j = 0; j < 20; j++)
			for (int i = 0; i < surnames_list.length && i < numberOfRecords; i++) {
				if (j >= male_names_list.length)
					j = 0;
				String name = surnames_list[i] + ", " + male_names_list[j++];
				names.add(name);
			}
		return names;
	}

	public static ArrayList<String> getFemaleNames(int numberOfRecords) {
		ArrayList<String> names = new ArrayList<>();
		if (numberOfRecords == -1)
			numberOfRecords = 1000;
		int j = 0;
		for (int i = 0; i < surnames_list.length && i < numberOfRecords; i++) {
			if (j >= female_names_list.length)
				j = 0;
			String name = surnames_list[i] + ", " + female_names_list[j++];
			names.add(name);
		}
		return names;
	}
	...
	public static ArrayList<Person> getPeople(int numb) {
		...
		int i = 0;
		for (String name : TestingHelper.getMaleNames(numb)) {
			Person stu = new Person();
			stu.setId(i++);
			stu.setCurrentColor(colors[getRandomInt(colors.length)]);
			stu.setActive(getRandomBoolean());
			stu.setName(name);
			stu.setAge(getRandomInt(100));
			Date randomDate = new Date(Math.abs(System.currentTimeMillis() - getRandomInt(1081743) * 1080000));
			stu.setDate(randomDate);
			people.add(stu);
		}

		for (int j = 0; j < 10; j++) {
			people_list.add(people.get(getRandomInt(numb)));
		}
		for (Person t : people) {
			t.setDirector(people_list.get(getRandomInt(10)));
		}
		return people;
	}
